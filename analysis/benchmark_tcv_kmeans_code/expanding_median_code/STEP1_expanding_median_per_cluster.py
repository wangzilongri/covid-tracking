...
def expanding_median_subroutine(df, fips_list, window_sizes=list(range(2,15)), shift_list=[7]):
    ...
    for window_size in window_sizes:
        ...
        daily_metrics_df["cumsum_mae_wsize={}".format(window_size)] = daily_metrics_df["mae_wsize={}".format(window_size)].expanding().median()
        daily_metrics_df["cumsum_rmse_wsize={}".format(window_size)] = daily_metrics_df["rmse_wsize={}".format(window_size)].expanding().median()
