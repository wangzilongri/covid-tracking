...
TLGRF_RDS_directory <- "../time_invariant_grf_results/time_invariant_grf_windowsize=2_numtrees=100"
file_pattern <- "time_invariant_grf_stateforest_cutoff=%d.rds"
...
fwrite(result_matrix, "time_invariant_feature_importance.csv", row.names=FALSE)
